...
Shannon-Prime is an implementation of Vilenkin-Hartley Transform, KV cache compression packaged as a portable library. It targets long-context inference on memory-constrained GPUs (consumer desktop CUDA, mobile Adreno/Vulkan).
