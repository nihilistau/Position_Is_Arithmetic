...
- **TurboQuant alignment test.** The prediction that lattice PE KV caches compress better under PolarQuant (lower residual MSE, lower attention score distortion at equivalent bit-width) is testable and planned.
