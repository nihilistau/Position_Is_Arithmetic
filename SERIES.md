...
| — | [GEMMA4-QUANT-FIX.md](GEMMA4-QUANT-FIX.md): community tutorial — verify the GGUF breakage + the fix recipe (post text: [GEMMA4-ISSUE-POST.md](GEMMA4-ISSUE-POST.md)) | gold 4.68 vs GGUFs 192–506; recipe ladder +45%→+9.6% | **written** | post alongside 06 |
